...
namespace Vision
{
    ...
    /// <summary>
    /// <see cref="Vision"/> plugin settings class.
    /// </summary>
    public sealed class VisionSettings : IPSettings
    {
        /// <summary>
        ...
        /// <summary>
        /// Ver nombres de vichos + buffos
        /// </summary>
        public bool ShowNPCNames = false;

        /// <summary>
        /// Npc Names Color
        /// </summary>
        public Vector4 NPCColor = new(1f, 0.5f, 0.5f, 1f);
        ...
        /// distinguished by using base chests icons.
        /// </summary>
        public Dictionary<string, IconPicker> HennesyIcons = new();
        ...
        public void AddDefaultIcons(string dllDirectory)
        {
            ...
            this.AddDefaultHennesyIcons(basicIconPathName);
        }
        ...
        private void AddDefaultHennesyIcons(string iconPathName)
        {
            //Currency
            ...
            this.HennesyIcons.TryAdd("LunarisFinalFormDaemon", new IconPicker(iconPathName, IconsPngCols, IconsPngRows, 0, 0, 30));
            this.HennesyIcons.TryAdd("ShakariFinalFormDaemon", new IconPicker(iconPathName, IconsPngCols, IconsPngRows, 0, 0, 30));
            this.HennesyIcons.TryAdd("SolarisFinalFormDaemon", new IconPicker(iconPathName, IconsPngCols, IconsPngRows, 0, 0, 30));

            //Maps

            this.HennesyIcons.TryAdd("TukohamaFinalFormDaemon", new IconPicker(iconPathName, IconsPngCols, IconsPngRows, 0, 0, 30));
            this.HennesyIcons.TryAdd("AbberathFinalFormDaemon", new IconPicker(iconPathName, IconsPngCols, IconsPngRows, 0, 0, 30));
            //Tukohama
            //Abberath

            //Cards

            this.HennesyIcons.TryAdd("ArakaaliFinalFormDaemon", new IconPicker(iconPathName, IconsPngCols, IconsPngRows, 0, 0, 30));
            this.HennesyIcons.TryAdd("BrineKingFinalFormDaemon", new IconPicker(iconPathName, IconsPngCols, IconsPngRows, 0, 0, 30));
            //Arakaali
            //Brine_King -Cangrejo gigante

            //Scarabs

            this.HennesyIcons.TryAdd("InnocenceFinalFormDaemon", new IconPicker(iconPathName, IconsPngCols, IconsPngRows, 0, 0, 30));
            //Innocence

            //Item Hight rarity

            this.HennesyIcons.TryAdd("KitavaFinalFormDaemon", new IconPicker(iconPathName, IconsPngCols, IconsPngRows, 0, 0, 30));
            //Kivata
            //FireProjectileRetaliationDaemon
            this.HennesyIcons.TryAdd("FireProjectileRetaliationDaemon", new IconPicker(iconPathName, IconsPngCols, IconsPngRows, 0, 14, 30));
        }
